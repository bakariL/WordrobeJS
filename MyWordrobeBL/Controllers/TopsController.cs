...
namespace MyWordrobeBL.Controllers
{
    public class TopsController : Controller
    {
        ...
        {
            var tops = db.Tops.Include(t => t.Color).Include(t => t.Occasion).Include(t => t.Photo).Include(t => t.Season).Include(t => t.TopSize);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.TopSizeID = new SelectList(db.TopSizes, "TopSizeID", "Size");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "TopsID,Name,ColorID,PhotoID,SeasonID,OccasionID,TopSizeID")] Top top)
        {
            ...
            ViewBag.ColorID = new SelectList(db.Colors, "ColorID", "ColorChoice", top.ColorID);
            ViewBag.OccasionID = new SelectList(db.Occasions, "OccasionID", "Occasion1", top.OccasionID);
            ViewBag.PhotoID = new SelectList(db.Photos, "PhotoID", "Photo1", top.PhotoID);
            ViewBag.SeasonID = new SelectList(db.Seasons, "SeasonID", "Season1", top.SeasonID);
            ViewBag.TopSizeID = new SelectList(db.TopSizes, "TopSizeID", "Size", top.TopSizeID);
            return View(top);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopsID,Name,ColorID,PhotoID,SeasonID,OccasionID,TopSizeID")] Top top)
        {
            if (ModelState.IsValid)
            {
